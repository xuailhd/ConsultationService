...
namespace HealthCloud.Consultation.Services.QQCloudy
{
    ...
    public class IMHelper: IIMHepler
    {  
        /// <summary>
        /// 获取全局随机数
        /// </summary>
        static int GlobalRandom
        {
            get
            {
                ...
                {
                    return (int)Manager.Instance.StringIncrement("IM.Random");
                }
                else
                {
        ...
        {
            string userSig = Tencent.TSLHelper.GetSig(uint.Parse(Configuration.IMConfig.sdkAppID), identifier.ToString(), uint.Parse(Configuration.IMConfig.accountType));
        ...
        /// <returns></returns>
        public ResponseIMMediaConfigDTO MediaConfig(string ChannelID, int Identifier,int Duration,int TotalTime,bool DisableWebSdkInteroperability)
        {
                String vendor_key =Configuration.MediaConfig.Key;
                String sign_key = Configuration.MediaConfig.Secret;
                ...
                {
                    AppID =Configuration.MediaConfig.Key,
        ...
        /// <returns></returns>
        public bool SendGroupTextMsg(string GroupId, int From_Account, string MsgContent)
        {
        ...
        /// <param name="MsgContent"></param>
        /// <returns></returns>
        public bool SendGroupSystemMsg(string GroupId, string MsgContent)
        {
            dynamic obj = new
            {
                GroupId = GroupId,
        ...
        public bool SendGroupImageMsg(string GroupId, int From_Account,string FileID,string FileUrl)
        {
            var MsgContent = new
            {
                UUID = FileID,
        ...
        /// <returns></returns>
        public bool SendGroupAudioMsg(string GroupId, int From_Account, string FileID, long FileSize,int Second)
        {
        ...
        /// <returns></returns>
        public bool SendGroupFileMsg(string GroupId, int From_Account, string FileID, long FileSize, string FileName)
        {
            var MsgContent = new
            {
                UUID = FileID,
        ...
        public bool QueryState(List<string> To_Accounts)
        {
            ...
            var result = JsonHelper.FromJson<ResponseIMQueryResultDTO>(response);
        ...
        /// <param name="Members"></param>
        /// <returns></returns>
        public bool AddGroupMember(string GroupId, List<int> Members)
        {
        ...
        /// <returns></returns>
        public bool ApplyAddFriend(string From_Account,List<AddFriendAccount> Accounts)
        {
            dynamic obj = new
            {
        ...
        //{
        //    KMEHosp.Common.LogHelper.WriteTrackLog("TrackQQCloudyApiOperatorLog",
...
namespace Tencent
{
    ...
    public static class TSLHelper
    {
        ...
        {
            var cacheKey = new StringCacheKey(StringCacheKeyType.KEY_IM_PriaveKey, SdkAppid.ToString());

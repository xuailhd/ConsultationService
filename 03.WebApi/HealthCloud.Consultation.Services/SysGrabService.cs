...
namespace HealthCloud.Consultation.Services
{
    ...
    {
        private StringCacheKey _CacheKey_TaskPool = null;
        private StringCacheKey _CacheKey_LatestTakeTime = null;
        ...
        /// <param name=""></param>
        /// <returns></returns>
        public EnumApiStatus TakeTask(string category, out T task, List<string> taskGroups)
        {
            task = default(T);
            ...
            if (Manager.Instance != null)
            {
                ...
                else
                {
                    ...
                    return EnumApiStatus.BizDoctorTaskAlreadyTaskUnhandledFinish;
                }

                return EnumApiStatus.BizDoctorTaskPoolEmpty;
            }
            else
            {
